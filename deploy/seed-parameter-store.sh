...
SECRET_KEYS=" DJANGO_SECRET_KEY DATABASE_PASSWORD GRAPH_CLIENT_SECRET METRICS_AUTH_TOKEN EXCHANGE_CERT_PASSWORD "
...
echo "  sudo systemctl restart pushit-api-gunicorn pushit-celery-worker pushit-celery-beat"
