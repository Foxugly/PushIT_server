...
def test_userkey_is_unique():
    user1 = User.objects.create_user(email="u1@website.com", password="1234")
    user2 = User.objects.create_user(email="u2@website.com", password="1234")
...
def test_user_language_defaults_to_fr():
    user = User.objects.create_user(email="u3@website.com", password="1234")
